...
// Usage:
//   node mix-audio.mjs --video out/colosseum-demo-1440p60-nocaptions.mp4 \
//     [--vo vo.wav] [--vo-db 0] [--bgm path.mp3] [--bgm-start 17.9] [--bgm-db -21] [--out path.mp4]
...
const video = resolve(arg('--video', join(HERE, 'out/keep-demo-1440p60-nocaptions.mp4')));
...
if (vo) {
  // the VO stem is already retimed to the authored timecodes — lay it in flat
